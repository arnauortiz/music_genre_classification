...
def main(model, epochs=30):
    ...
    data_list, genres_list = LoadDataPipeline('mfcc')
    ...
    for epoch in range(1, epochs + 1):
        ...
        if acc > accmax:
            ...
            accmax = acc
            y_pred = prediction
        mfcc_accuracies.append(acc)
    return model, targets, probas, y_pred, accmax, train_dataloader, test_dataloader, mfcc_accuracies

if __name__ == "__main__":
    model, targets, probas, y_pred, accmax, _, _, _ = main(RNN('mfcc'))
