...
def main(model, epochs=30):
    ...
    data_list, genres_list = LoadDataPipeline('chroma')
    ...
    for epoch in range(1, epochs + 1):
        ...
        if acc > accmax:
            ...
            accmax = acc
            y_pred = prediction
        chroma_accuracies.append(acc)
    return model, targets, probas, y_pred, accmax, train_dataloader, test_dataloader, chroma_accuracies


if __name__ == "__main__":
    model, targets, probas, y_pred, accmax, _, _, _ = main(RNN('chroma'))
